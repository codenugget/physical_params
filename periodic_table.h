...
PeriodicElement periodic_table[] =
{
    ...
    {  96,   102,      7,  247.000,   13.50,                1340,                3110,   5.99,      0,   "f", "Curium"       ,  "Cm",  "[Rn] 5f7 6d1 7s2"      ,  "*" },
    {  97,   102,      7,  247.000,   14.78,                 986,                2627,   6.20,      0,   "f", "Berkelium"    ,  "Bk",  "[Rn] 5f9 7s2"          ,  "*" },
    {  98,   102,      7,  251.000,   15.10,                 900,                1470,   6.28,      0,   "f", "Californium"  ,  "Cf",  "[Rn] 5f10 7s2"         ,  "*" },
    {  99,   102,      7,  252.000,    0.00,                 860,                 996,   6.42,      0,   "f", "Einsteinium"  ,  "Es",  "[Rn] 5f11 7s2"         ,  "*" },
    { 100,   102,      7,  257.000,    0.00,                1527, cUnknownTemperature,   6.50,      0,   "f", "Fermium"      ,  "Fm",  "[Rn] 5f12 7s2"         ,  "*" },
    { 101,   102,      7,  258.000,    0.00,              826.85, cUnknownTemperature,   6.58,      0,   "f", "Mendelevium"  ,  "Md",  "[Rn] 5f13 7s2"         ,  "*" },
    { 102,   102,      7,  259.000,    0.00,                 827, cUnknownTemperature,   6.65,      0,   "f", "Nobelium"     ,  "No",  "[Rn] 5f14 7s2"         ,  "*" },
    { 103,     3,      7,  262.000,    0.00,                1627, cUnknownTemperature,   4.90,      0,   "d", "Lawrencium"   ,  "Lr",  "[Rn] 5f14 7s2 7p1"     ,  "*" },
    { 104,     4,      7,  261.000,   17.00,                2100,                5500,   0.00,      0,   "d", "Rutherfordium",  "Rf",  "[Rn] 5f14 6d2 7s2"     ,  "*" },
    { 105,     5,      7,  262.000,   21.60, cUnknownTemperature, cUnknownTemperature,   0.00,      0,   "d", "Dubnium"      ,  "Db",  "[Rn] 5f14 6d3 7s2"     ,  "*" },
    { 106,     6,      7,  266.000,   23.50, cUnknownTemperature, cUnknownTemperature,   0.00,      0,   "d", "Seaborgium"   ,  "Sg",  "[Rn] 5f14 6d4 7s2"     ,  "*" },
    { 107,     7,      7,  264.000,   26.50, cUnknownTemperature, cUnknownTemperature,   0.00,      0,   "d", "Bohrium"      ,  "Bh",  "[Rn] 5f14 6d5 7s2"     ,  "*" },
    { 108,     8,      7,  277.000,   28.00, cUnknownTemperature, cUnknownTemperature,   0.00,      0,   "d", "Hassium"      ,  "Hs",  "[Rn] 5f14 6d6 7s2"     ,  "*" },
